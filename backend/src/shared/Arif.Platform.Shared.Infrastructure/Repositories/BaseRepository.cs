...
namespace Arif.Platform.Shared.Infrastructure.Repositories;

public class BaseRepository<T> : IRepository<T> where T : BaseEntity
{
    protected readonly ArifPlatformDbContext _context;
    protected readonly DbSet<T> _dbSet;

    public BaseRepository(ArifPlatformDbContext context)
    {
        _context = context;
