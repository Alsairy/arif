...
using Arif.Platform.Subscription.Infrastructure.Services;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Arif Platform Subscription API",
        Version = "v1",
        Description = "Subscription management service with billing, plan management, and usage tracking.",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Arif Platform Subscription API v1");
...
app.MapGet("/", () => new
{
    Service = "Arif Platform Subscription Service",
    Version = "1.0.0",
