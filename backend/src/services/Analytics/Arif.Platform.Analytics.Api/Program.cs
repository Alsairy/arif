...
using Arif.Platform.Analytics.Infrastructure.Services;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Arif Platform Analytics API",
        Version = "v1",
        Description = "Advanced analytics service with real-time dashboards, predictive insights, and performance optimization.",
...
builder.Services.AddScoped<IZeroTrustSecurityService, ZeroTrustSecurityService>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Arif Platform Analytics API v1");
...
app.MapGet("/", () => new
{
    Service = "Arif Platform Analytics Service",
    Version = "1.0.0",
    ...
    Features = new[]
    {
        ...
        "Zero-Trust Security",
        "Auto-scaling Analytics Processing",
        "Arabic Language Analytics Support"
    }
});
