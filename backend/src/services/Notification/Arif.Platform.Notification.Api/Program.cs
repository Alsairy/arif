...
using Arif.Platform.Notification.Infrastructure.Services;
using Arif.Platform.Notification.Infrastructure.Hubs;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Arif Platform Notification API",
        Version = "v1",
        Description = "Multi-channel notification service with email, SMS, push notifications, and real-time alerts.",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Arif Platform Notification API v1");
...
app.MapGet("/", () => new
{
    Service = "Arif Platform Notification Service",
    Version = "1.0.0",
