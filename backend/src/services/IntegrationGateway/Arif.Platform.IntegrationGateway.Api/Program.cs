...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Arif Platform Integration Gateway API",
        Version = "v1",
        Description = "Integration gateway service for external system integrations with multi-tenant support and Arabic language capabilities.",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Arif Platform Integration Gateway API v1");
...
app.MapGet("/", () => new
{
    Service = "Arif Platform Integration Gateway Service",
    Version = "1.0.0",
